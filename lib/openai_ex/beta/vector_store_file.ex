defmodule OpenaiEx.Beta.VectorStore.File do
  @moduledoc """
  ...
  defp ep_url(vector_store_id, file_id \\ nil) do
    "/vector_stores/#{vector_store_id}/files" <> if is_nil(file_id), do: "", else: "/#{file_id}"
  end
  ...
  def new(args = %{vector_store_id: vector_store_id}) do
    %{
  ...
  """
  def create(openai = %OpenaiEx{}, _params = %{vector_store_id: vector_store_id, file_id: file_id}) do
    openai
  ...
  """
  def retrieve(openai = %OpenaiEx{}, _params = %{vector_store_id: vector_store_id, file_id: file_id}) do
    openai
    |> OpenaiEx.with_assistants_beta()
  ...
  """
  def delete(openai = %OpenaiEx{}, _params = %{vector_store_id: vector_store_id, file_id: file_id}) do
    openai
    |> OpenaiEx.with_assistants_beta()
  ...
  def new_list(args = %{vector_store_id: _}) do
    args |> Map.take([:vector_store_id | OpenaiEx.list_query_fields()])
  end

  def list(openai = %OpenaiEx{}, params = %{vector_store_id: vector_store_id}) do
    openai
    |> OpenaiEx.with_assistants_beta()
    |> OpenaiEx.Http.get(ep_url(vector_store_id), params |> Map.take(OpenaiEx.list_query_fields()))
  end
end
